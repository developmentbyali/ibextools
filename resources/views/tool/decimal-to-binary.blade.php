...
@section('title',' Decimal To Binary- IBEX Tools')
@section('description','Convert your Decimal code into Binary.')
@section('keywords','decimal to binary')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Decimal into Binary Converter</h1>

                    <decimal-to-binary-component></decimal-to-binary-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>In the conversion of decimal to binary, we have to change a base 10 number into a base 2 number
                                with the help of some simple techniques.
