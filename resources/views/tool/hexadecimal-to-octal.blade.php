...
@section('title',' Hexadecimal To Octal- IBEX Tools')
@section('description','Convert your Hecadecimal code into Octal.')
@section('keywords','hexadecimal To octal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Hexadecimal into Octal Converter</h1>

                    <hexadecimal-to-octal-component></hexadecimal-to-octal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>step 1: Separate the digits of the given hex number, if it contains more than 1 digit.
