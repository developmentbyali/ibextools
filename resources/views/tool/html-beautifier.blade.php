...
@section('title','HTMl Beautifier/Formatter - IBEX Tools')
        ...
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Beautify Your HTML</h1>
                    <p class="text-left">Have to deal with HTML formatting? Then this site is made for you! Use our super handy online tool to minify (uglify) or beautify (prettify) your data.</p>

                    <html-beautify-component></html-beautify-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online HTML Beautifier </h5>
                            <p>
