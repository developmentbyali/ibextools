...
@section('title','Binary To Decimal- IBEX Tools')
@section('description','Convert your Binary code into Decimal.')
        ...
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Convert Binary into Decimal</h1>

                    <binary-to-decimal-component></binary-to-decimal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            ...
                            <p>Using Online Converter to easily convert your Binary code into
                               Decimal code on one click,Simply write your Binary code and tab the Run
                               Minify button.
                               ...
                               numeral. The four-bit BCD code for any particular single base-10 digit
                               is its representation in binary notation,as follow 0000=0
                            </p>
