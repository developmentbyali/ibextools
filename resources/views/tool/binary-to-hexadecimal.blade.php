...
@section('title','Binary To Hexadecimal- IBEX Tools')
@section('description','Convert your Binary code into Hexadecimal.')
@section('keywords','binary to decimal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Convert Binary into Hexadecimal</h1>

                    <binary-to-hexadecimal-component></binary-to-hexadecimal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>Using Online Converter to easily convert your Binary code into
                               Hexadecimal code on one click,Simply write your Binary code and tab the Run
                               Minify button.
                               Binary coded Hexadecimal (BCH) is a system of writing numerals that assigns a
                               four-digit binary code to each digit 0 through 15 in a decimal (base-16)
                               numeral. The four-bit BCH code for any particular single base-16 digit
                               is its representation in binary notation
                            </p>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="binary-to-string" class="toolColor"><li class="list-group-item">Binary To String</li></a>
                                </ul>
                            </div>
                        </div>
                    </div>
