...
@section('title','Obj to XML - IBEX Tools')
@section('description','Convert XML your Object. Make your JSON Object to XML online.')
@section('keywords','XML your Object, XML Online, Obj to XML, Uglify Jquery, compress js, js Minify online, js Uglify online, compress js online')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Obj to XML </h1>
                    <p class="text-left">Have to deal with JS XML? Then this site is made for you! Use our super handy online tool to minify (uglify) or beautify (prettify) your data.</p>

                    <json-to-xml-component></json-to-xml-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
