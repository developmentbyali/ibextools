...
@section('title','Binary To Octal- IBEX Tools')
@section('description','Convert your Binary code into Octal.')
@section('keywords','binary to octal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Convert Binary into Octal</h1>

                    <binary-to-octal-component></binary-to-octal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>Using Online Converter to easily convert your Binary code into
                               Octal code on one click,Simply write your Binary code and tab the Run
                               Minify button.
                               Binary coded octal (BCO) is a system of writing numerals that assigns a
                               four-digit binary code to each digit 0 through 7 in a decimal (base-8)
                               numeral. The four-bit BCO code for any particular single base-8 digit
