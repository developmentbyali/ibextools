...
@section('title',' Octal To Hexadecimal- IBEX Tools')
@section('description','Convert your Octal code in Hexadecimal .')
@section('keywords','octal To hexadecimal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Octal into Hxadecimal Converter</h1>

                    <octal-to-hexadecimal-component></octal-to-hexadecimal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>The octal number system is a base-8 number system. ... The hexadecimal number system, on the other hand,
                                is a base-16 number system. This means that it has a total of 16 symbols
                            </p>
                        ...
                        <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="octal-to-decimal"class="toolColor"><li class="list-group-item">Octal to Decimal</li></a>
