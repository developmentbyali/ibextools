...
@section('title',' XML Formatter- IBEX Tools')
@section('description','XML Formatter And Beautifier .')
@section('keywords','xml formatter')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > XML Formatter And Beautifier </h1>

                    <xml-formatter-component></xml-formatter-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="#" class="toolColor"><li class="list-group-item">XML Entities Escape </li></a>
                                    <a href="#" class="toolColor"><li class="list-group-item">XML Entities Unescape </li></a>
