...
@section('title',' Octal To Binary- IBEX Tools')
@section('description','Convert your Octal code in Binary .')
@section('keywords','octal To binary')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Octal into Binary Converter</h1>

                    <octal-to-binary-component></octal-to-binary-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>Since there are only 8 symbols (i.e., 0, 1, 2, 3, 4, 5, 6, and 7) in octal representation system and
                                its base (i.e., 8) is equivalent of 23=8.
