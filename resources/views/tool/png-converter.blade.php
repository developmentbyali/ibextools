...
@section('title','Back Link Maker - IBEX Tools')
@section('description','Back Link Maker.')
@section('keywords','back-link maker')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >BackLinks Maker</h1>

                    <png-converter-component></png-converter-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>Backlinks are incoming links to a webpage. When a webpage links to any other page,
                            it's called a backlink. In the past, backlinks were the major metric for the ranking of a webpage.
                            A page with a lot of
                            backlinks tended to rank higher on all major search engines, including Google.
                            </p>
