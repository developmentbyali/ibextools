...
@section('title',' JSON Decode- IBEX Tools')
@section('description','Decode your Json String .')
@section('keywords','json decode')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >JSON Decode</h1>
                    <json-decode-component></json-decode-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
