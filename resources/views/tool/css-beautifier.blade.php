        ...
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Beautify Your CSS</h1>
                    <p class="text-left">Have to deal with CSS formatting? Then this site is made for you! Use our super handy online tool to minify (uglify) or beautify (prettify) your data.</p>
                    <beautify-component></beautify-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online CSS Beautifier </h5>
                            <p>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="js-beautifier" class="toolColor"><li class="list-group-item">JS Beautifier</li></a>
                                </ul>
                            </div>
                        </div>
                    </div>
