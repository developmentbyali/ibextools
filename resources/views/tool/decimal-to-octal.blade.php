...
@section('title',' Decimal To Octal- IBEX Tools')
@section('description','Convert your Decimal code into Octal.')
@section('keywords','decimal to octal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Decimal into Octal Converter</h1>

                    <decimal-to-octal-component></decimal-to-octal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                        ...
                        <div class="card mb-2" >
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="decimal-to-hexa" class="toolColor"><li class="list-group-item">Decimal To Hexadecimal</li></a>
