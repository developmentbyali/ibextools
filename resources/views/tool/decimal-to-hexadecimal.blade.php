...
@section('title',' Decimal To Hexadecimal- IBEX Tools')
@section('description','Convert your Decimal code into Hexadecimal.')
@section('keywords','decimal to hexa')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Decimal into Hexadecimal Converter</h1>

                    <decimal-to-hexa-component></decimal-to-hexa-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>In decimal to binary, we divide the number by 2, in decimal to hexadecimal
                                we divide the number by 16. In case of decimal to octal,
                                we divide the number by 8 and write the remainders in the reverse order to get
                                 the equivalent octal number. Decimal Number: All the numbers to the base ten are called as decimal numbers
                            </p>
                        ...
                        <div class="card mb-2" >
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="decimal-to-binary" class="toolColor"><li class="list-group-item">Decimal To Binary </li></a>
                                    <a href="decimal-to-octal" class="toolColor"><li class="list-group-item">Decimal To Octal</li></a>
