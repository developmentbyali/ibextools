...
@section('title',' JSON Encode- IBEX Tools')
@section('description','Encode your Json String .')
@section('keywords','json encode')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >JSON Encode</h1>
                    <json-encode-component></json-encode-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
