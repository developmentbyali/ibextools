...
@section('title',' Hexadecimal To Decimal- IBEX Tools')
@section('description','Convert your Hecadecimal code into Decimal.')
@section('keywords','hexadecimal To decimal')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Hexadecimal into Decimal Converter</h1>

                    <hexadecimal-to-decimal-component></hexadecimal-to-decimal-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>To convert a hexadecimal to a decimal manually, you must start by multiplying
                                the hex number by 16. Then, you raise it to a power of 0 and increase that
                                power by 1 each time according to the hexadecimal number equivalent.
                                We start from the right of the hexadecimal number and go to the left
                                when applying the powers.Feb 7, 2019
                        ...
                        <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="hexadecimal-to-binary" class="toolColor"><li class="list-group-item">Hexadecimal to Binary </li></a>
