...
@section('title','Main Components - IBEX Tools')
@section('description','Beautify your code to clean it up. Make your code easier to read and validate it.')
@section('keywords',' formatter, format code,  beautifier, beautify code, code parser, js validator')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center text-primary " >Main Components</h1>
                    <p class="text-center">Have to deal with rough-formatting? Then this site is made for you! Use our super handy online tool to minify (uglify) or beautify (prettify) your data and much more.</p>

                    <js-beautify-component></js-beautify-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Free Components </h5>
                            <p>
                                Meet some Minify and Beautify components, a simple online tool that does exactly what it says; minifies and beautifies  quickly and easily. Minify your data in a hassle-free way, or beautify it into human-readable format.
                            </p>
                            <p>
                            ...
                            <p>
                                Begin with the "type (or paste) here..." area to enter your data, then hit the "minify" or "beautify" buttons respectively. After a blink of any eye, the results will be shown below these buttons. Alternatively, use the "click (or tap) here..." area to select JS files from your device, then hit the corresponding button. Once the upload and processing completes, you will be notified to copy the resulting Data file. That's all!
                            </p>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="css-beautifier" class="toolColor"><li class="list-group-item">CSS Beautifier</li></a>
                                </ul>
                            </div>
                        </div>
                    </div>
