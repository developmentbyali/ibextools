...
@section('title','CSS Minify/Uglify - IBEX Tools')
@section('description','Minify/Uglify your css code. Make your css code beautiful and easy for developer to read.')
@section('keywords','csss Minify, css Uglify, Uglify css, make css beautiful, css Minify online, css Uglify online, make css code beautiful online free')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" >Uglyfy CSS or Minify CSS </h1>
                    <p class="text-left">Have to deal with CSS Minifing? Then this site is made for you! Use our super handy online tool to minify (uglify) or beautify (prettify) your data.</p>

                    <css-minify-component></css-minify-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online CSS Minifier </h5>
                            <p>
                                Meet CSS Minify and Beautify, a simple online tool that does exactly what it says; minifies and beautifies JavaScripts quickly and easily. Minify your data in a hassle-free way, or beautify it into human-readable format.
                            </p>
                            <p>
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="card mb-2" >
                                <ul class="list-group list-group-flush text-center">
                                    ...
                                    <a href="js-minify" class="toolColor"><li class="list-group-item">JS Minify</li></a>
                                </ul>
                            </div>
                        </div>
                    </div>
