...
@section('title',' SHA256 Hash Genrator- IBEX Tools')
@section('description','Convert your String in SHA256 .')
@section('keywords','sha256 hash genrator')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > SHA256 Hash Genrator</h1>
                    <sha256-component></sha256-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
                <div class="col mb-4 py-4 shadow-sm bg-white rounded">
                    <div class="row">
                        ...
                        <h5 class="mb-3 px-3 py-2 bg-primary text-light">Online Converter</h5>
                            <p>SHA256 algorithm generates an almost-unique, fixed size 256-bit (32-byte) hash.
                                 Hash is so called a one way function. This makes it suitable for
                                 checking integrity of your data, challenge hash authentication, anti-tamper,
