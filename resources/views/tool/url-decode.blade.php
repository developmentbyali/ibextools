...
@section('title',' URL Decode - IBEX Tools')
@section('description','Decode Url  .')
@section('keywords','url decoder')
@section('content')
    <section class="mt-5">
        <div class="container-fluid pl-5 pr-5">
            ...
            <div class="row">
                <div class="col tool-working shadow-sm p-3 mb-4 bg-white rounded">
                    <h1 class="p-2 text-center" > Url Decode</h1>

                    <url-decode-component></url-decode-component>
                </div>
            </div>
            <!-- FEATURES-->
            <div class="row">
