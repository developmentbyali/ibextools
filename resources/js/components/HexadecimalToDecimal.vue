<template>
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            <div class="row">
                <div class="col ">
                    <h4 class="text-left pb-2 b-color-primary result-title">Simply enter your Hexaecimal Code</h4>
                </div>
            </div>
            <div class="text-center mb-3">
                <button class="btn btn-primary minifyButton mb-0" @click="hexatodecimal()">Run Minify</button>
...
<script>
    ...
    export default {
       ...
       mounted() {
            mixpanel.track("Load: Hexadecimal To Decimal",);
        },
        ...
        methods: {
          ...
          hexatodecimal(){
                mixpanel.track("Use: Hexadecimal To Decimal hexatodecimal ",);
                let hexaNumber = this.hexa_text;
                let binary=((parseInt(hexaNumber, 16)).toString(10));
                if(hexaNumber!==''){
