<template>
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="buttonWrappers mt-0 mb-3 text-center">
                <button class="btn btn-primary minifyButton mb-0 " @click="decimaltobinary()">Run Minify</button>
                ...
                <button v-if="contentResult" v-clipboard="contentResult" @click="copyToClipboard" id="copytoClipboard" class="mt-0 btn btn-success" type="button">Copy Output</button>
            </div>
            <div class="row">
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load: Decimal To Binary",);
        },
        methods: {
            copyToClipboard() {
           ...
           decimaltobinary(){
              mixpanel.track("Use:Decimal To Binary decimaltobinary",);
              let decimal=this.decimal_text;
              let binary= Number(decimal).toString(2).substr(-8);
