    ...
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="text-center mb-3">
                <button class="mb-0 btn btn-primary minifyButton" @click="sha512encrypt()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load:SHA 512 Hash Genrator",);
        },
        methods: {
            copyToClipboard() {
          ...
          sha512encrypt(){
                mixpanel.track("Use:SHA 512 Hash Genrator sha512encrypt",);
                let sha1=this.sha1_text;
                let sha1Hash =CryptoJS.SHA512(sha1).toString();
