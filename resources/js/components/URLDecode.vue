<template>
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            <div class="row">
                <div class="col ">
                    <h4 class="text-left pb-2 b-color-primary result-title">Simply enter your EncodedUrl</h4>
                </div>
            </div>
            <div class="text-center mb-3">
                <button class="mb-0 btn btn-primary minifyButton" @click="urlDecode()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load:Url Decode",);
        },
        ...
        methods: {
            ...
            urlDecode(){
                mixpanel.track("Use:Url Decode urlDecode",);
                let uri = this.string_text;
                let decode = decodeURI(uri);
                let result='No output';
                if(uri!==''){
                    this.contentResult = decode.toString();
                }
                else{
                    this.$alertify.error('URL is empty');
