    ...
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="text-center mb-3">
                <button class="mb-0 btn btn-primary minifyButton" @click="stringtobinary()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load:String To Binary",);
        },
        ...
        methods: {
           ...
           stringtobinary(){
                mixpanel.track("Use:String To Binary stringtobinary",);
                ...
                if(str!==''){
                    ...
                    this.contentResult = textToBinary(str)
                }
                else{
