    ...
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="text-center mb-3">
                <button class="btn btn-primary minifyButton mb-0" @click="decimaltooctal()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load: Decimal To Octal",);
        },
        methods: {
            copyToClipboard() {
           ...
           decimaltooctal(){
              mixpanel.track("Use:Decimal To Octal decimaltooctal",);
              let decimal=this.decimal_text;
              let binary= Number(decimal).toString(8);
