    ...
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="text-center mb-3">
                <button class="mb-0 btn btn-primary minifyButton" @click="sha1encrypt()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load:SHA 1 Hash Genrator",);
        },
        ...
        methods: {
          ...
          sha1encrypt(){
                mixpanel.track("Use:SHA 1 Hash Genrator sha1encrypt",);
                let sha1=this.sha1_text;
                let sha1Hash =CryptoJS.SHA1(sha1).toString();
