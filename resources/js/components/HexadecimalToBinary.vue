    ...
    <div class="row">
        <div class="col-12 pt-4 pb-4">
            ...
            <div class="text-center mb-3">
                <button class="btn btn-primary minifyButton mb-0" @click="hexatobinary()">Run Minify</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            mixpanel.track("Load: Hexadecimal To Binary",);
        },
        ...
        methods: {
          ...
          hexatobinary(){
              mixpanel.track("Use: Hexadecimal To Binary hexatobinary",);
                let hexaNumber = this.hexa_text;
                let binary=((parseInt(hexaNumber, 16)).toString(2));
                if(hexaNumber!==''){
